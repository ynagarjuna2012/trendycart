        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="quantity"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
              &nbsp;
              <input type="image" src="catalog/view/theme/izistore/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              &nbsp;<a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/izistore/image/miniRemove.jpg" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
          ...
          <tr>
            ...
            <td class="quantity"><input type="text" name="" value="1" size="1" disabled="disabled" />
              &nbsp;<a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/izistore/image/miniRemove.jpg" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
