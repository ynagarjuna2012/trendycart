			...
			<?php if ($price && $special): ?>
                    <div class="off">
                        <?php 
                              ...
                              $normal =  strip_tags(str_replace($currCode,'', $price));
                                $normalP = strip_tags(str_replace(',','', $normal));
                              $special = strip_tags(str_replace($currCode,'', $special));
      ...
      <div class="price"><?php echo $text_price; ?>
        ...
        <?php } ?>
          <?php if ($review_status) { ?>
              <div class="review">
                	<div><img src="catalog/view/theme/izistore/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a> - <a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
              </div>
          <?php } ?>
      </div>
      <?php } ?>
