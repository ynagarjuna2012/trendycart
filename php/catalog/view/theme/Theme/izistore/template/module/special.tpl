<div class="box-special">
  ...
  <p class="subHeading">Lorem Ipsum dolor sit amet is simply dummy text of the type setting industry</p>
  <div class="box-content">
    <ul class="box-product specialProduct">
      ...
      <li <?php if($i%4==0){ echo 'class="last"'; }?>>
        ...
        <?php } ?>
       <?php /*?> <div class="cart"><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button" /></div><?php */?>
      </li>
      <?php 
	  		if($i%4==0 && $pCount>4 && $pCount>$i){
				echo '</ul><ul>';
			}
	  ?>
      <?php } ?>
    ...
    <ul class="prevNext2">
      <li><a id="prev2"><span>Prev</span></a></li>
      <li><a id="next2"><span>Next</span></a></li>
	</ul>
</div>
<script type="text/javascript"><!--
	$(window).load(function() {
		$('.box-special .box-content').cycle({
			fx: 'scrollHorz',
			speed: 800,
			timeout: 0,
			pause: 1,
